    ...
    public class DefenseShields : MyGameLogicComponent
    {
        ...
        public void DrawShield(float size)
        {
            if (!Initialized && _cblock.IsWorking)
            {
                ...
                MySimpleObjectDraw.DrawTransparentSphere(ref edgeMatrix, 1f, ref colour, MySimpleObjectRasterizer.Solid, 12, null, MyStringId.GetOrCompute("Build new"), 0.25f, -1);
