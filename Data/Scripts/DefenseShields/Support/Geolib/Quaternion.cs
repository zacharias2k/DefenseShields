...
{
    /// <summary>
    /// Unit Quaternion2 (W + X*i + Y*j + Z*k).
    /// </summary>
    public class Quaternion2
    {
        ...
        #region "Constructors"
        /// <summary>
        /// Default constructor, initializes Quaternion2 with zero rotation (1,0,0,0).
        /// </summary>
        /// <param name="coord">Reference coordinate system (default - Coord3d.GlobalCS).</param>
        public Quaternion2(Coord3d coord = null)
        {
            _w = 1; _x = 0; _y = 0; _z = 0;
        ...
        /// <summary>
        /// Initializes Quaternion2.
        /// </summary>
        /// <param name="coord">Reference coordinate system (default - Coord3d.GlobalCS).</param>
        public Quaternion2(double w, double x, double y, double z, Coord3d coord = null)
        {
            _w = w; _x = x; _y = y; _z = z;
            _coord = (coord == null) ? Coord3d.GlobalCS : coord;
        }
        ...
        /// <summary>
        /// Initializes Quaternion2 using double array.
        /// </summary>
        /// <param name="coord">Reference coordinate system (default - Coord3d.GlobalCS).</param>
        public Quaternion2(double[] q, Coord3d coord = null)
        {
            if (q.GetUpperBound(0) < 3)
                throw new Exception("Quaternion2: Array size mismatch");
            _w = q[0];
            _x = q[1];
            _y = q[2];
            _z = q[3];
        ...
        /// <summary>
        /// Initializes Quaternion2 using axis of rotation and angle.
        /// </summary>
        ...
        /// <summary>
        /// Initializes Quaternion2 using rotation matrix.
        /// </summary>
        /// <param name="m">Rotation matrix.</param>
        /// <param name="coord">Reference coordinate system (default - Coord3d.GlobalCS).</param>
        public Quaternion2(Matrix3d m, Coord3d coord = null)
        {
            if (!m.IsOrthogonal)
            {
        ...
        {
            return new Quaternion2(this.W, this.X, this.Y, this.Z, _coord);
        }
        ...
        /// <summary>
        /// Square of the norm of a Quaternion2
        /// </summary>
        ...
        /// <summary>
        /// Conjugate of a Quaternion2
        /// </summary>
        public Quaternion2 Conjugate
        {
            get {
                Quaternion2 qq = this.Copy();
                qq.X = -this.X;
                qq.Y = -this.Y;
                qq.Z = -this.Z;
                return qq;
        ...
        /// </summary>
        public Quaternion2 Normalized
        {
            get
            {
                Quaternion2 tmp = this.Copy();
        ...
        /// <summary>
        /// Normalize the current Quaternion2
        /// </summary>
        ...
        public Quaternion2 Scale(double a)
        {
            return new Quaternion2(_w*a, _x*a, _y*a, _z*a, this.Coord);
        }
        ...
        /// <summary>
        /// Convert Quaternion2 to global coordinate system.
        /// </summary>
        public Quaternion2 ConvertToGlobal()
        {
            ...
            else
            {
                ...
                return new Quaternion2(axis, angle);
            }
        }

        /// <summary>
        /// Convert Quaternion2 to reference coordinate system.
        /// </summary>
        public Quaternion2 ConvertTo(Coord3d coord)
        {
            if (_coord == null || object.ReferenceEquals(_coord, Coord3d.GlobalCS))
            {
                return this.Copy();
        ...
        // Operators overloads
        //-----------------------------------------------------------------
        public static Quaternion2 operator +(Quaternion2 q1, Quaternion2 q2)
        {
            return q1.Add(q2);
        }
        ...
        public static Quaternion2 operator *(Quaternion2 q1, double a)
        {
            return q1.Scale(a);
        }
        ...
        public static Quaternion2 operator *(double a, Quaternion2 q1)
        {
            return q1.Scale(a);
        }

        public static Quaternion2 operator -(Quaternion2 q1)
        {
            return q1.Scale(-1.0);
        }

        public static bool operator ==(Quaternion2 q1, Quaternion2 q2)
        {
            return q1.Equals(q2);
        }
        public static bool operator !=(Quaternion2 q1, Quaternion2 q2)
