...
namespace DefenseShields.Support
{
    ...
    {
        private Vector3D size = Vector3D.Zero;
        ...
        private Vector3D halfSize = Vector3D.Zero;
        ...
        {
            MatrixD abs; CollisionMath.Absolute(ref orientation, out abs);
            Vector3D temp;
            Vector3D.Transform(ref halfSize, ref abs, out temp);

            box.Max = temp;
            Vector3D.Negate(ref temp, out box.Min);
        }
