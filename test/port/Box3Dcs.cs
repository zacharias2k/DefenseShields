...
namespace DefenseShields.Test
{
    ...
    public class Box3d : IFiniteObject
    {
        ...
        /// </summary>
        public Box3d(Point center, double lx, double ly, double lz)
        {
            _center = center;
            _lx = lx;
            _ly = ly;
        ...
        public Box3d(Point center, double lx, double ly, double lz, Rotation r)
        {
            _center = center;
            _lx = lx;
            _ly = ly;
        ...
        public Box3d(Point center, double lx, double ly, double lz, Coord3d coord)
        {
            _center = center;
            _lx = lx;
            _ly = ly;
        ...
        {
            get { return new List<Point> { P1, P2, P3, P4, P5, P6, P7, P8 }; }
        }
        ...
        {
            coord = (coord == null) ? Coord3d.GlobalCS : coord;
            Point c = _center.ConvertTo(coord);
            double mx = c.X;
            double my = c.Y;
            double mz = c.Z;

            foreach (Point p in this.ListOfPoints)
            {
                Point t = p.ConvertTo(coord);
                if (t.X < mx) mx = t.X;
                if (t.Y < my) my = t.Y;
                if (t.Z < mz) mz = t.Z;
            }
        ...
        public BoundingSphereD BoundingSphere
        {
            get
            {
                ...
                return new BoundingSphereD(this.BoundingSphere.Center, r);
            }
        }
        #endregion
        ...
        public string ToString(Coord3d coord)
        {
            ...
            Point p = _center.ConvertTo(coord);
