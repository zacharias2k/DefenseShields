...
namespace Jitter.Collision.Shapes
{
    ...
    public class TriangleMeshShape : Multishape
    {
        ...
        /// called.</returns>
        public override int Prepare(ref BoundingBox box)
        {
        ...
        public override void GetBoundingBox(ref Matrix orientation, out BoundingBox box)
        {
