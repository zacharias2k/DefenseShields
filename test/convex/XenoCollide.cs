...
namespace DefenseShields.Support
{
    ...
    public sealed class XenoCollide
    {
             ...
             out Vector3D point, out Vector3D normal, out double penetration)
        {
            ...
            if ( v0.LengthSquared() < MathHelper.EPSILON * MathHelper.EPSILON) v0 = new Vector3D(0.00001f, 0, 0);
            ...
            if (Vector3D.Dot(v1, normal) <= 0.0f) return false;
            ...
            if (Vector3D.Dot(v2, normal) <= 0.0f) return false;
            ...
            while (true)
            {
                ...
                while (true)
                {
                    ...
                    if (normal.LengthSquared() < MathHelper.EPSILON * MathHelper.EPSILON) return true;
